...
const alunos = jsoon.Pages.aprovAdm.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
...
const melhoresAlunosMes = jsoon.Pages.melhoresMesAdm.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
    ...
    return (
        <>
            <main>
                ...
                <h2 className={a.mdb}>Melhores do bimestre (ADM)</h2> 
