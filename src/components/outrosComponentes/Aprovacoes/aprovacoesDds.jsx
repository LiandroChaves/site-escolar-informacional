...
const alunos = jsoon.Pages.aprovdds.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
...
const melhoresAlunosMes = jsoon.Pages.aprovdds.melhoresDoMesDds.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
    ...
    return (
        <>
            <main>
                ...
                <h2 className={a.mdb}>Melhores do bimestre (D.D.S)</h2> 
