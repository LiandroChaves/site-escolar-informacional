...
const alunos = jsoon.Pages.aprov.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
...
const melhoresAlunosMes = jsoon.Pages.aprov.melhoresDoMes.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
                ...
                <div className={a.linha_aprov}>
                    ...
                    <div className={a.dropdown}>
                        ...
                        <ul className={a.dropdown_menu}>
                            <Link to="/aprovadm"><li>administração</li></Link>
                            <Link to="/aprovdds"><li>Des. de Sistemas</li></Link>
                            <Link to="/aprovedf"><li>Edificações</li></Link>
                            <Link to="/aprovasso"><li>Massoterapia</li></Link>
                        </ul>
                    </div>
                </div>
