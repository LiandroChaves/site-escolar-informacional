...
const alunos = jsoon.Pages.aprovEdf.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
...
const melhoresAlunosMes = jsoon.Pages.aprovMelhoresEdf.alunos.map((item)=>{
    return(
        {
            nome: item.nome,
            curso: item.curso,
